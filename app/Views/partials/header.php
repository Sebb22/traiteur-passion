<header class="header">
    <div class="header__container">
        ...
        <nav class="header__nav header__nav--desktop" aria-label="Navigation principale">
            ...
            <a href="/à propos" class="header__link">A propos</a>
    ...
    <div class="menu" id="menuOverlay" hidden>
        ...
        <div class="menu__panel" role="dialog" aria-modal="true" aria-label="Menu">
            <div class="menu__top">
                <a href="/" class="menu__brand" aria-label="Traiteur Passion - Accueil">
                    <img src="/uploads/images/logos/logoNav.png" alt="Traiteur Passion" width="160" height="auto"
                        loading="eager">
                </a>
            ...
            <div class="menu__content">
                <div class="menu__links" aria-label="Accès">
                    ...
                    <a class="menu__link" href="/nous-decouvrir">
