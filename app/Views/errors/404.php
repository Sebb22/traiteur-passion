<?php
    ...
    $secondaryAction = $secondaryAction ?? ['href' => '/carte-évènementielle', 'label' => 'Voir la carte évènementielle'];
    $hints           = $hints ?? [
    'Vérifiez l\'orthographe de l\'URL si vous l\'avez saisie à la main.',
    'Repartez de la carte évènementielle ou de l\'accueil pour retrouver la bonne page.',
